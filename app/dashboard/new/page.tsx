...
//this route is responsible for creating a new event type 

type VideoCallProvider= "Zoom Meeting" | "Google Meet" | "Microsoft Teams"
const NewEventType=()=>{
    const[activePlatform,setActivePlateform] = useState<VideoCallProvider>("Google Meet");
    
    //get data from server
    const [lastResult ,  action ]= useFormState(CreateEventTypeAction,undefined)
    //validate with conform
    ...
    return(
        <div className="w-full h-full flex- flex-1 items-center justify-center">
            <Card>
                <CardHeader>
                    <CardTitle>Add new appointement type</CardTitle>
                    <CardDescription >
                        Create new appointement tyepe that allows people to book you.
                    </CardDescription>
                </CardHeader>
                <form id={form.id} onSubmit={form.onSubmit} action={action} noValidate>
                    <CardContent className="grid gap-y-5">
                        ...
                        <div className="grid gap-y-2">
                            ...
                            {/* the url will be like this format: localhost:3000/userName/30-meeting */}
